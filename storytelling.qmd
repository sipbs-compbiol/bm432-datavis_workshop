...
> We measured chlorosis in 30 plants after the application of either AvrX or AvrY. @fig-misleading-01 demonstrates that induction of chlorosis was stronger for AvrY than for AvrX.
...
#| fig-width: 3
#| fig-height: 3
#| fig-cap: "Bar chart showing amount of chlorosis in leaves after application of AvrX and AvrY"
...
::: { .callout-questions }
1. How does @fig-misleading-01 support the statement that AvrY induces chlorosis more strongly than AvrX?
2. What information is present in @fig-misleading-01?
3. What information do you think you need that is not present in @fig-misleading-01?
:::
...
#| fig-width: 3
#| fig-height: 3
#| fig-cap: "Bar chart showing effect of chlorosis due to application of AvrX and AvrY, with observed chlorosis values indicated on the y-axis"
...
::: { .callout-questions }
1. What conclusions can you draw from @fig-misleading-02 that couldn't be drawn from @fig-misleading-01?
2. Is @fig-misleading-02 a fair representation of the data?
...
## How humans interpret graphs (click to expand)

Research shows that people do, in fact, interpret bar charts by bar *area*, not bar *height*. Humans have a limited repertoire of elementary perceptual tasks that we use to extract data and information from graphical representation (@Cleveland1984-mk). Graphs may use these well for communication, or [misuse them to fool the reader](https://www.theguardian.com/news/datablog/2014/may/12/lies-election-leaflets-five-tricks-european-elections). 

A number of studies empirically test people's ability to correctly "read" graph types, and the results indicate that bar charts do not perform very well (@Heer2010-hk).
:::
...
#| fig-width: 3
#| fig-height: 3
#| fig-cap: "Bar chart showing effect of chlorosis due to application of AvrX and AvrY, with the y-axis starting at zero, and values marked"
...
::: { .callout-questions }
1. What conclusions can you draw from @fig-misleading-03 that couldn't be drawn from @fig-misleading-02?
2. Does @fig-misleading-03 tell the same story as @fig-misleading-02?
...
It's unlikely that all of the measurements for each gene were identical. We would assume that there has been some *spread* of data around that location. This spread is commonly represented with error bars, as in @fig-misleading-04.
...
#| fig-width: 3
#| fig-height: 3
#| fig-cap: "Bar chart showing effect of chlorosis due to application of AvrX and AvrY, with the y-axis starting at zero, values marked on that axis, and error bars indicating standard deviation"
