...
- **For each figure, consider the following:**
  ...
  - How would you grade this figure according to [University Marking Guide B](https://sipbs-compbiol.github.io/bm432-datavis_workshop/marking_guide.html)?
- Fill in the _pro forma_ with your scoring and free-text answers to the questions above (one sentence each)
  - [Google Form](https://forms.gle/PxyTHFho3c8Cn6nD9)
...
<center>
```{r eff_wordcloud}
explain = data.frame(cbind(c(dfm$explain_fig1, dfm$explain_fig2, dfm$explain_fig3, dfm$explain_fig4)))
...
<center>
```{r imp_wordcloud}
improvements = data.frame(cbind(c(dfm$improvements_fig1, dfm$improvements_fig2, dfm$improvements_fig3, dfm$improvements_fig4)))
